...
Which of the following numerical variables are continuous? Which
are discrete? (Note: Discrete variables are those that have a finite set of
predefined values, whereas continuous variables can take any value within a
given interval.)
...
\begin{marginfigure} 
\includegraphics[width=\linewidth]{Pizza.png} 
\caption{Pizza for exercise 10.} 
\end{marginfigure}
