---
title: "Statistik für Biologie FS 2023"
...
```{r,fig.margin = TRUE,fig.align='center',libraries.eval,echo = TRUE,results='hide', message=F, warning=F}
...
## GGplot 2
We start with some examples of how to visualize data quickly and easily. This should show you how to produce high quality visulaizations using R and motivate you to learn more about programming and data analysis with R. 
...
```{r,fig.margin = TRUE,fig.align='center',mileage2}
ggplot(data = mpg) + 
  geom_point(mapping = aes(x = displ, y = hwy)) +
  theme_classic()
```
...
```{r,fig.margin = TRUE,fig.align='center',mileage_aes}
ggplot(data = mpg) + 
...
```{r,fig.margin = TRUE,fig.align='center',mileage_aes_2}
ggplot(data = mpg) + 
...
```{r,fig.margin = TRUE,fig.align='center',mileage_aes_themes}
p = ggplot(data = mpg) + 
  geom_point(mapping = aes(x = displ, y = hwy), color = "blue") 
...
```{r,fig.margin = TRUE,fig.align='center'}
plot(mpg$displ,mpg$hwy,pch=16,col="darkblue",
     xlab="displ",ylab="hwy", main ="a scatterplot")
...
```{r,fig.margin = TRUE,fig.align='center'}
setwd("/Users/stephan_1/Dropbox/Teaching/BlogdownPages/StatForBioFS22")
```
...
```{r,fig.margin = TRUE,fig.align='center',results = "hide"}
...
We continue using the stickleback data set and calculate some statistics on it. A simple way to get a quick overview about the properties of your data frame is using the funciton *summary*:
...
```{r,fig.margin = TRUE,fig.align='center',fig.show='hide'}
reps = 1000
sample_size = 10
mu = 10
sigma = 5
...
```{r,fig.margin = TRUE,fig.align='center',message = FALSE}
...
```{r,fig.margin = TRUE,fig.align='center',echo = F, warning = F,message = FALSE}
...
```{r,fig.margin = TRUE,fig.align='center'}
heat <- read.csv("~/Dropbox/Teaching/BlogdownPages/StatisticsForBiology/ABD_all_data/chapter11/chap11e3Temperature.csv")
...
$$(X F - 32) * 5/9 = Y C$$
```{r,fig.margin = TRUE,fig.align='center',heat_histo2}
...
```{r,fig.margin = TRUE,fig.align='center'}
lizard <- read_csv("~/Dropbox/Teaching/BlogdownPages/StatisticsForBiology/ABD_all_data/chapter12/chap12e3HornedLizards.csv")
head(lizard)
```
...
```{r,fig.margin = TRUE,fig.align='center'}
marine <- read_csv("~/Dropbox/Teaching/BlogdownPages/StatisticsForBiology/ABD_all_data/chapter13/chap13e1MarineReserve.csv")
head(marine)
...
# Exercises 
Exercises can be found [here (html)](https://s-peischl.github.io/StatForBioFS22/Exercises_web.html)
or [here (pdf)](https://s-peischl.github.io/StatForBioFS22/Exercises_web.pdf)
