...
```{r,fig.margin = TRUE,setup, include=FALSE}
...
```{r,fig.margin = TRUE,libraries.eval,echo = TRUE,results='hide', message=F, warning=F}
...
```{r,fig.margin = TRUE,mileage_aes_2}
ggplot(data = mpg) + 
...
```{r,fig.margin = TRUE,mileage_aes_themes}
p = ggplot(data = mpg) + 
  geom_point(mapping = aes(x = displ, y = hwy), color = "blue") 
...
```{r,fig.margin = TRUE,fig.show='hide'}
reps = 1000
sample_size = 10
mu = 10
sigma = 5
...
```{r,fig.margin = TRUE,echo = F, warning = F,message = FALSE}
